export type Team = "VILLAGEOIS" | "WEREWOLVES" | "SOLO" | "LOVERS" | "DYNAMIC";
...
export const ROLES: RoleDef[] = [
  ...
  },
  {
    ...
    team: "VILLAGEOIS",
    description:
      "Un villageois aux trois visages : protecteur, alchimiste et devin. Il reste du côté du village, mais brouille les pistes des loups et force chacun à mentir ou à se remettre en question.",
    power:
      "Sur 3 nuits différentes de son choix, il active un pouvoir différent (chacun une seule fois) : Protection du Salvateur, une potion de la Sorcière (vie OU mort), ou l'inspection de la Voyante.",
    order: 51,
    hasNightAction: true,
  },
  {
    ...
    team: "DYNAMIC",
    description:
      "Ombre sans visage, il échange son identité avec un autre villageois dès la première nuit. Son camp dépend entièrement de ce qu'il dérobe.",
    power:
      "Nuit 1 uniquement : vole le rôle d'un joueur. La cible devient Simple Villageois ; le Voleur hérite du rôle, du camp et des pouvoirs volés pour le reste de la partie.",
    order: 5,
    firstNightOnly: true,
    hasNightAction: true,
  },
  {
    ...
    team: "SOLO",
    description:
      "Âme chaotique et solitaire, il ne sert ni le village ni la meute : il veut simplement être le dernier debout.",
    power:
