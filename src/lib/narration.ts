...
const NARRATION: Partial<Record<Lang, Table>> & { fr: Table } = {
  fr: {
    ...
    renardVagueManiac: "🔪 Un bruit de pas solitaire résonne, insensible aux protections.",
    renardVagueSilence: "🤐 Un murmure étouffé — quelqu'un se tait contre son gré.",
    renardVagueNothing: "🌙 La nuit fut étrangement calme.",
    renardVagueInfect: "🦠 Une transformation sombre s'éveille — quelqu'un rejoint la meute.",
    renardVagueHeal: "⚗️ Une lueur chaleureuse de guérison pulse dans la nuit.",
    renardVagueSeer: "🔮 Un regard perçant balaie le village, découvrant des secrets.",
    renardVagueShield: "🛡️ Le Bouclier Ultime protège tout le village.",
    renardReportAttack: "🐺 Les loups ont attaqué {name}.",
    renardReportInfect: "🦠 Les loups ont infecté {name} — il/elle rejoint la meute.",
    renardReportHeal: "⚗️ La Sorcière a utilisé sa potion de vie pour sauver {name}.",
    renardReportPoison: "☠️ La Sorcière a utilisé sa potion de mort sur {name}.",
    renardReportSeer: "🔮 La Voyante a inspecté {name} et découvert qu'il/elle est {role}.",
    renardReportProtect: "🛡️ Le Salvateur a protégé {name}.",
    renardReportShield: "🛡️ Le Bouclier Ultime protège tout le village.",
    renardReportSilence: "🤐 {name} a été réduit(e) au silence pour le débat.",
    renardReportManiac: "🔪 Le Maniaque a assassiné {name}.",
    renardReportNothing: "🌙 La nuit fut calme — aucun événement notable.",
  ...
  en: {
    ...
    protectAlreadyDone: "{name} has already been protected during this cycle.",
    ...
    infectedKill: "The infected wolf devours {name}.",
    infectedFallback: "Night {n}: all original wolves eliminated — the infected wolf hunts alone.",
    ...
    renardVaguePoison: "☠️ A scent of bitter herbs lingers in the air.",
    renardVagueManiac: "🔪 A lone footstep echoes, heedless of any protection.",
    renardVagueSilence: "🤐 A stifled whisper — someone falls silent against their will.",
    renardVagueNothing: "🌙 The night was strangely calm.",
    renardVagueInfect: "🦠 A dark transformation stirs — someone joins the pack.",
    renardVagueHeal: "⚗️ A warm glow of healing pulses through the night.",
    renardVagueSeer: "🔮 An all-seeing gaze sweeps the village, uncovering secrets.",
    renardVagueShield: "🛡️ The Ultimate Shield protects the entire village.",
    renardReportAttack: "🐺 The wolves attacked {name}.",
    renardReportInfect: "🦠 The wolves infected {name} — they joined the pack.",
    renardReportHeal: "⚗️ The Witch used her life potion to save {name}.",
    renardReportPoison: "☠️ The Witch used her death potion on {name}.",
    renardReportSeer: "🔮 The Seer inspected {name} and discovered they are {role}.",
    renardReportProtect: "🛡️ The Guardian protected {name}.",
    renardReportShield: "🛡️ The Ultimate Shield protects the entire village.",
    renardReportSilence: "🤐 {name} was silenced for the debate.",
    renardReportManiac: "🔪 The Maniac murdered {name}.",
    renardReportNothing: "🌙 The night was calm — no notable events.",
  ...
  ar: {
    ...
    protectAlreadyDone: "{name} تمّت حمايته بالفعل في هذه الدورة.",
    ...
    infectedKill: "الذئب المصاب يفترس {name}.",
    infectedFallback: "الليلة {n} : جميع الذئاب الأصلية أُبيدت — الذئب المصاب يصطاد وحده.",
    ...
    winWolves: "الذئب المستذئب افترست القرية.",
    ...
    renardVaguePoison: "☠️ رائحة أعشاب مرة تعبق في الهواء.",
    renardVagueManiac: "🔪 وقت خطوات منفرد يتردد، لا تهتم بأي حماية.",
    renardVagueSilence: "🤐 همسة مخنوقة — أحدهم يصمت رغمًا عنه.",
    renardVagueNothing: "🌙 كانت الليلة غريبة في هدوئها.",
    renardVagueInfect: "🦠 تحول مظلم يستيقظ — أحدهم ينضم إلى القطيع.",
    renardVagueHeal: "⚗️ وميض دافئ من الشفاء ينبض في الليل.",
    renardVagueSeer: "🔮 نظرة ثاقبة تجتاح القرية، تكشف الأسرار.",
    renardVagueShield: "🛡️ الدرع الأقصى يحمي القرية كلها.",
    renardReportAttack: "🐺 الذئاب هاجمت {name}.",
    renardReportInfect: "🦠 الذئاب حوّلت {name} — انضم إلى القطيع.",
    renardReportHeal: "⚗️ الساحرة استعملت جرعة الحياة لإنقاذ {name}.",
    renardReportPoison: "☠️ الساحرة استعملت جرعة الموت على {name}.",
    renardReportSeer: "🔮 العرافة كشفت {name} واكتشفت أنه/ا {role}.",
    renardReportProtect: "🛡️ المنقذ حمى {name}.",
    renardReportShield: "🛡️ الدرع الأقصى يحمي القرية كلها.",
    renardReportSilence: "🤐 {name} تم إسكاته للنقاش.",
    renardReportManiac: "🔪 المهووس اغتال {name}.",
    renardReportNothing: "🌙 الليلة كانت هادئة — لا أحداث بارزة.",
  ...
  es: {
    ...
    protectAlreadyDone: "{name} ya ha sido protegido durante este ciclo.",
    ...
    renardVagueManiac: "🔪 Un paso solitario resuena, ajeno a toda protección.",
    renardVagueSilence: "🤐 Un susurro ahogado — alguien enmudece contra su voluntad.",
    renardVagueNothing: "🌙 La noche fue extrañamente tranquila.",
    renardVagueInfect: "🦠 Una transformación oscura despierta — alguien se une a la manada.",
    renardVagueHeal: "⚗️ Un brillo cálido de curación pulsa en la noche.",
    renardVagueSeer: "🔮 Una mirada penetrante barre la aldea, descubriendo secretos.",
    renardVagueShield: "🛡️ El Escudo Definitivo protege toda la aldea.",
    renardReportAttack: "🐺 Los lobos atacaron a {name}.",
    renardReportInfect: "🦠 Los lobos infectaron a {name} — se unió a la manada.",
    renardReportHeal: "⚗️ La Bruja usó su poción de vida para salvar a {name}.",
    renardReportPoison: "☠️ La Bruja usó su poción de muerte en {name}.",
    renardReportSeer: "🔮 El Vidente inspeccionó a {name} y descubrió que es {role}.",
    renardReportProtect: "🛡️ El Salvador protegió a {name}.",
    renardReportShield: "🛡️ El Escudo Definitivo protege toda la aldea.",
    renardReportSilence: "🤐 {name} fue silenciado para el debate.",
    renardReportManiac: "🔪 El Maníaco asesinó a {name}.",
    renardReportNothing: "🌙 La noche fue tranquila — sin eventos destacables.",
  ...
  pt: {
    ...
    protectAlreadyDone: "{name} já foi protegido durante este ciclo.",
    ...
    cause_WITCH_POISON: "envenenado pela Bruja",
    ...
    renardVagueManiac: "🔪 Um passo solitário ecoa, alheio a qualquer proteção.",
    renardVagueSilence: "🤐 Um sussurro abafado — alguém silencia contra a vontade.",
    renardVagueNothing: "🌙 A noite foi estranhamente calma.",
    renardVagueInfect: "🦠 Uma transformação sombria desperta — alguém se junta à alcateia.",
    renardVagueHeal: "⚗️ Um brilho quente de cura pulsa na noite.",
    renardVagueSeer: "🔮 Um olhar penetrante varre a aldeia, descobrindo segredos.",
    renardVagueShield: "🛡️ O Escudo Supremo protege toda a aldeia.",
    renardReportAttack: "🐺 Os lobos atacaram {name}.",
    renardReportInfect: "🦠 Os lobos infetaram {name} — juntou-se à alcateia.",
    renardReportHeal: "⚗️ A Bruxa usou a poção de vida para salvar {name}.",
    renardReportPoison: "☠️ A Bruxa usou a poção de morte em {name}.",
    renardReportSeer: "🔮 O Vidente inspecionou {name} e descobriu que é {role}.",
    renardReportProtect: "🛡️ O Salvador protegeu {name}.",
    renardReportShield: "🛡️ O Escudo Supremo protege toda a aldeia.",
    renardReportSilence: "🤐 {name} foi silenciado para o debate.",
    renardReportManiac: "🔪 O Maníaco assassinou {name}.",
    renardReportNothing: "🌙 A noite foi calma — sem eventos destacáveis.",
  ...
  ru: {
    ...
    protectAlreadyDone: "{name} уже был под защитой в этом цикле.",
    ...
    renardVaguePoison: "☠️ Запах горьких трав витает в воздухе.",
    renardVagueManiac: "🔪 Одиночный шаг звучит, не обращая внимания на защиту.",
    renardVagueSilence: "🤐 Приглушённый шёпот — кто-то замолкает против воли.",
    renardVagueNothing: "🌙 Ночь была странно спокойной.",
    renardVagueInfect: "🦠 Тёмное пробуждение — кто-то присоединяется к стае.",
    renardVagueHeal: "⚗️ Тёплое сияние исцеления пульсирует в ночи.",
    renardVagueSeer: "🔮 Пронзительный взгляд обводит деревню, раскрывая тайны.",
    renardVagueShield: "🛡️ Абсолютный Щит защищает всю деревню.",
    renardReportAttack: "🐺 Волки атаковали {name}.",
    renardReportInfect: "🦠 Волки заразили {name} — он присоединился к стае.",
    renardReportHeal: "⚗️ Ведьма использовала зелье жизни, чтобы спасти {name}.",
    renardReportPoison: "☠️ Ведьма использовала зелье смерти на {name}.",
    renardReportSeer: "🔮 Ясновидящая проверила {name} и обнаружила, что он/а {role}.",
    renardReportProtect: "🛡️ Спаситель защитил {name}.",
    renardReportShield: "🛡️ Абсолютный Щит защищает всю деревню.",
    renardReportSilence: "🤐 {name} был лишён голоса для обсуждения.",
    renardReportManiac: "🔪 Маньяк убил {name}.",
    renardReportNothing: "🌙 Ночь была спокойной — никаких примечательных событий.",
  ...
  zh: {
    ...
    protectAlreadyDone: "{name} 在本轮循环中已经被保护过了。",
    ...
    infectedKill: "感染狼吞食了 {name}。",
    infectedFallback: "第 {n} 夜：所有原始狼人已被消灭 — 感染狼独自狩猎。",
    ...
    renardVaguePoison: "☠️ 苦涩草药的气味弥漫在空气中。",
    renardVagueManiac: "🔪 孤独的脚步声回荡，无视任何保护。",
    renardVagueSilence: "🤐 一声压抑的低语 — 有人被迫沉默。",
    renardVagueNothing: "🌙 夜晚异常平静。",
    renardVagueInfect: "🦠 黑暗的觉醒 — 有人加入了狼群。",
    renardVagueHeal: "⚗️ 温暖的治愈之光在夜色中脉动。",
    renardVagueSeer: "🔮 洞察的目光扫过村庄，揭示秘密。",
    renardVagueShield: "🛡️ 终极护盾保护了整个村庄。",
    renardReportAttack: "🐺 狼群攻击了 {name}。",
    renardReportInfect: "🦠 狼群感染了 {name} — 他加入了狼群。",
    renardReportHeal: "⚗️ 女巫使用解药救了 {name}。",
    renardReportPoison: "☠️ 女巫对 {name} 使用了毒药。",
    renardReportSeer: "🔮 预言家查验了 {name}，发现他/她是 {role}。",
    renardReportProtect: "🛡️ 守卫保护了 {name}。",
    renardReportShield: "🛡️ 终极护盾保护了整个村庄。",
    renardReportSilence: "🤐 {name} 被禁言，无法参与讨论。",
    renardReportManiac: "🔪 狂人谋杀了 {name}。",
    renardReportNothing: "🌙 夜晚平静 — 没有值得注意的事件。",
  ...
  de: {
    ...
    renardVagueManiac: "🔪 Ein einsamer Schritt hallt wider, unbeeindruckt von jedem Schutz.",
    renardVagueSilence: "🤐 Ein ersticktes Flüstern — jemand verstummt wider Willen.",
    renardVagueNothing: "🌙 Die Nacht war seltsam ruhig.",
    renardVagueInfect: "🦠 Eine dunkle Verwandlung erwacht — jemand tritt dem Rudel bei.",
    renardVagueHeal: "⚗️ Ein warmes Leuchten der Heilung pulsiert in der Nacht.",
    renardVagueSeer: "🔮 Ein durchdringender Blick streift das Dorf und offenbart Geheimnisse.",
    renardVagueShield: "🛡️ Der Ultimative Schild schützt das gesamte Dorf.",
    renardReportAttack: "🐺 Die Wölfe haben {name} angegriffen.",
    renardReportInfect: "🦠 Die Wölfe haben {name} infiziert — er/sie tritt dem Rudel bei.",
    renardReportHeal: "⚗️ Die Hexe hat ihren Lebenstrank verwendet, um {name} zu retten.",
    renardReportPoison: "☠️ Die Hexe hat ihren Gifttrank auf {name} verwendet.",
    renardReportSeer: "🔮 Der Seher hat {name} überprüft und entdeckt, dass er/sie {role} ist.",
    renardReportProtect: "🛡️ Der Beschützer hat {name} beschützt.",
    renardReportShield: "🛡️ Der Ultimative Schild schützt das ganze Dorf.",
    renardReportSilence: "🤐 {name} wurde für die Debatte zum Schweigen gebracht.",
    renardReportManiac: "🔪 Der Verrückte hat {name} ermordet.",
    renardReportNothing: "🌙 Die Nacht war ruhig — keine nennenswerten Ereignisse.",
